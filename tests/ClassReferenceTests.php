...
class ClassReferenceTests extends BaseTestClass
{
    ...
    {
        $patterns = [
            "new '<class_ref>'(); new User(); new '<class_ref>'();" => ['replace' => '"<1>"::class;"<2>"::class;'],
        ];
        $startCode = '<?php new \App\Models\User(); new User(); new App\Models\User();';
        $resultCode = '<?php \App\Models\User::class;App\Models\User::class;';
    ...
    {
        $patterns = [
            "new '<class_ref>'(); new '<class_ref>'(); new '<class_ref>'();" => ['replace' => '"<1>"::class;"<2>"::class;"<3>"::class;'],
        ];
        $startCode = '<?php new User(); new \App\Models\User(); new App\Models\User();';
        $resultCode = '<?php User::class;\App\Models\User::class;App\Models\User::class;';
        [$newVersion, $replacedAt] = Searcher::searchReplace($patterns, token_get_all($startCode));
    ...
    {
        $patterns = [
            "new '<full_class_ref>'(); '<full_class_ref>'();" => ['replace' => '"<1>";'],
        ];
